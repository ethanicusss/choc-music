...
public class ModMusic {
    ...
    public static final Music END_BOSS = new Music(ModSounds.MUSIC_END_BOSS.get(), 0, 0, true);//0 min/max game delay and last value = true - this music will replace any currently playing music immediately. Use for important event music.
